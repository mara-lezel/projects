...
class SmallClassicMap:
    def __init__(self):
        ...
        self.ghost_AI = [AI_MIXED, AI_NORMAL]
        self.ghost_color = [RED, BLUE]
...
class MediumClassicMap:
    def __init__(self):
        ...
        self.ghost_AI = [AI_AGGRESSIVE, AI_NORMAL]
        self.ghost_color = [RED, BLUE]
...
class CapsuleMap:
    def __init__(self):
        ...
        self.ghost_AI = [AI_AGGRESSIVE, AI_NORMAL, AI_NORMAL]
        self.ghost_color = [RED, BLUE, ORANGE]
